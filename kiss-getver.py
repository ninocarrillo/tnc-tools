...
kiss_output_frame += bytearray(int(0x0).to_bytes(1,'big'))
print(kiss_output_frame)

kiss_output_frame = bytearray(int(FEND).to_bytes(1,'big')) + bytearray(KISS_TYPE_ID) + kiss_output_frame + bytearray(int(FEND).to_bytes(1,'big'))
print(kiss_output_frame)
